...
void setup() {
 ...
 /*
  ...
  Serial.println("");
  free(temp_msg);  
  size_of_packet = create_packet(&temp_msg, NULL, 0, true, 2, 59);
  Serial.print("Packet ack ciphered with empty places + 0: ");
  for (int i = 0; i < size_of_packet; i++)
    {
      Serial.print(temp_msg[i]);
      Serial.print(", ");
...
/*
  ...
  Serial.print("Packet ack NOT ciphered with empty places + 0: ");
  for (int i = 0; i < size_of_packet; i++)
    {
      Serial.print(temp_msg[i]);
      Serial.print(", ");
